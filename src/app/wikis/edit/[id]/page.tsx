    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-xl p-8 space-y-6 border border-white/40 shadow-lg">
      ...
      <form onSubmit={handleUpdate} className="space-y-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          <textarea value={content} onChange={e => setContent(e.target.value)} className="form-textarea w-full border border-gray-300 p-3 rounded-lg bg-white text-gray-900 placeholder-gray-500 transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-gray-400 min-h-24 resize-vertical"
 rows={6} required />
        </div>
